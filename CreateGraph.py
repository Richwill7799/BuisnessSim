...
#print(filename)
i = 0
for filename in glob.glob(dirname + '\Assets\StreamingAssets\*.txt'): #get every file that's has .txt in the folder
    xValue = 1;
    file = open(filename)
...
#print(dirname)
plt.savefig('C:\Users\sakob\Desktop\Test\BuisnessSim_Data\StreamingAssets')
